...
def convert_md_to_html(md_path, html_path, lang="it"):
    ...
    # Enhance job blocks and matrix categories to have page-break-inside: avoid wrappers
    # Wrap ### in a job-block div
    ...
    full_html = CSS_TEMPLATE.replace("{lang}", lang).replace("{lang_upper}", lang.upper()).replace("{content}", final_content)
...
if __name__ == "__main__":
    convert_md_to_html("cv_it.md", "cv_it.html", lang="it")
    convert_md_to_html("cv_en.md", "cv_en.html", lang="en")
