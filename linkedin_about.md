...
• In ForMinds (Co-Founder & CTO), sviluppiamo molteplici software custom e percorsi di corporate academy per grandi gruppi enterprise (erogati per conto di primarie società di consulenza e formazione partner intermediarie); tra i nostri progetti di punta figura la piattaforma di Pharmaceutical Demand & Sales Forecasting per il cliente bhave di Roma, portando modelli matematici predittivi time-series in produzione su microservizi cloud sicuri e conformi agli standard GxP.
